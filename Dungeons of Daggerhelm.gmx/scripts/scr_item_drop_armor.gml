...
exceptional_chance = irandom_range(0,30-(floor(global.lv/3)));
tremendous_chance = irandom_range(0,38-(floor(global.lv/3)));
epic_chance = irandom_range(0,50-(floor(global.lv/2)));
